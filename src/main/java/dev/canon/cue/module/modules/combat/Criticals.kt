...
import dev.canon.cue.event.events.player.MotionEvent
import dev.canon.cue.inject.client.ICPacketPlayer
import dev.canon.cue.inject.client.INetworkManager
...
class Criticals : Module() {
    ...
    private fun send(yOffset: Double) {
        (mc.player.connection.networkManager as INetworkManager).hookDispatchPacket(
