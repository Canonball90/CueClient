package cn.origin.cube.guis.spodify;
...
public class SpotifyAPI {
    ...
    public final SpotifyApi SPOTIFY = new SpotifyApi.Builder()
            .setClientId("b23e42d0c7a34e46a822592c6a91adcd")
    ...
    private final SpotifyCallback callback = code -> {
        ChatUtil.sendMessage(PREFIX + " Connecting...");
