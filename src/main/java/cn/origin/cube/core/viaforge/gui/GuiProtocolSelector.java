package cn.origin.cube.core.viaforge.gui;
...
public class GuiProtocolSelector extends GuiScreen {
    ...
    public void drawScreen(int p_drawScreen_1_, int p_drawScreen_2_, float p_drawScreen_3_) {
        ...
        Cube.fontManager.CustomFont.drawCenteredStringWithShadow("ViaForge", width / 4, 6, -1);
        GL11.glPopMatrix();
    ...
    class SlotList extends GuiSlot {
        ...
        protected void drawSlot(int i, int i1, int i2, int i3, int i4, int i5, float v) {
            Cube.fontManager.CustomFont.drawCenteredStringWithShadow(ProtocolCollection.getProtocolById(ProtocolCollection.values()[i].getVersion().getVersion()).getName(), width / 2, i2, ViaForge.getInstance().getVersion() == ProtocolCollection.values()[i].getVersion().getVersion() ? ColorUtils.rainbow().getRGB() : -1);
        }
    }
}
