...
public class GuiPlaylistManager extends GuiMineTunes {
	...
	public void drawScreen(int mx, int my, float partialTicks) {
		...
		boolean creatingPlaylist = Cube.playlistCreatorThread != null;
		if(creatingPlaylist) {
			String creating = TextFormatting.DARK_AQUA + I18n.format("minetunes.gui.creatingPlaylist");
			String status = Cube.playlistCreatorThread.getProgressState();
	...
	protected void keyTyped(char c, int i) throws IOException {
		if(Cube.playlistCreatorThread == null)
	...
	protected void actionPerformed(GuiButton button) {
		...
		case 5:
			...
			break;
		case 6:
			if(currentPlaylist == selectedPlaylist && Cube.musicPlayerThread != null)
				Cube.musicPlayerThread.resetPlayer();
	...
	public static void selectCurrentPlaylist(int playlist, int song) {
		...
		if(Cube.musicPlayerThread != null)
			Cube.musicPlayerThread.onPlaylistChange();
	}
